export default {
  ...
  security: {
    ...
    commandApprovalHint:
      "Controls whether the agent must ask before running terminal commands. Smart allows routine commands automatically and asks only for risky ones.",
    modeManual: "Manual",
    modeSmart: "Smart",
    modeOff: "Off",
    cronApproval: "Cron job approval",
    cronApprovalHint:
      "How scheduled cron jobs are approved: approve them automatically, or prompt for each run.",
    cronApprove: "Approve",
    cronPrompt: "Prompt",
    denyRules: "Deny rules",
    denyHint:
      "Commands matching these glob patterns are always blocked — even with approval mode off.",
    denyPlaceholder: "rm -rf *\ngit push --force",
    allowlist: "Command allowlist",
    allowlistHint:
      "Commands matching these patterns run without prompting. Use shell-style wildcards, e.g. git status.",
    allowlistPlaceholder: "git status\nls -la",
    writeApproval: "Write approval gates",
    writeApprovalHint:
      "Require explicit approval before the agent modifies your memory or skills.",
    memoryWrites: "Memory writes",
    skillWrites: "Skill writes",
    workingFolder: "Working folder",
    workingFolderHint:
      "The folder the agent starts in. Its terminal and file tools operate relative to this directory.",
    workingFolderPlaceholder: "e.g. C:\\Users\\you\\projects\\myapp",
    browse: "Browse…",
    save: "Save",
    saving: "Saving…",
    saveDeny: "Save deny rules",
    saveAllowlist: "Save allowlist",
    savedApprovalMode: "Approval mode saved",
    savedCronMode: "Cron approval saved",
    savedDeny: "Deny rules saved",
    savedAllowlist: "Allowlist saved",
    savedWriteApproval: "Write approval saved",
    savedWorkDir: "Working folder saved",
  },
