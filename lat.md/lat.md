...
- [[chat-completion-latency]] — the id-cursor tail read and tail reconcile that keep finishing a turn O(tail) instead of re-reading and re-reconciling the whole session.
